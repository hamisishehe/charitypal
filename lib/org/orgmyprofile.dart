...
import 'package:charitypal/org/orgchangepassword.dart';
import 'package:firebase_auth/firebase_auth.dart';
import 'package:flutter/material.dart';
import 'package:get/get.dart';

class Orgmyprofile extends StatefulWidget {
  const Orgmyprofile({super.key});

  @override
  State<Orgmyprofile> createState() => _OrgmyprofileState();
}

class _OrgmyprofileState extends State<Orgmyprofile> {
                ...
                Container(
                  ...
                  child: Column(
                    children: [
                      ...
                      GestureDetector(
                        onTap: (){
                          Get.to(Orgchangepassword(), fullscreenDialog: true);
                        },
                        child: const Padding(
