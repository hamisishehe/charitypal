...
class Singleorgevent extends StatefulWidget {
  final eventmodel post;
  const Singleorgevent({super.key, required this.post});

  @override
  State<Singleorgevent> createState() => _SingleorgeventState();
}

class _SingleorgeventState extends State<Singleorgevent> {
  @override
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    IconButton(onPressed: () async {
                      ...
                      Navigator.pop(context, MaterialPageRoute(builder: (context) => Orgevents(),));
